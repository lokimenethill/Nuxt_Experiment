        ...
        <div class="contenedor-pantalla-emergente contenedor-pantalla-emergente-mixteco">
          ...
          <div class="contenedor-columnas-pantalla-emergente ">
            ...
            <div class="columna-derecha-pantalla-emergente ">
              <figure class="figure-pantalla-emergente ">
                <img class="imagen-pantalla-emergente" :src="datasend.imgUri" alt="">
          ...
          <div class="footer-pantalla-emergente ">
            <div class="footer-columna-item lexicons-footer-item-pantalla-emergente ">
              ...
              <a v-for="(element, index) in datasend.lexicons" :key="index" :v-bind="index" class="vinculo-footer-pantalla-emergente">{{element.display}}</a>
            ...
            <div class="footer-columna-item ">
              ...
              <a v-for="(element, index) in datasend.floraFauna" :key="index" :v-bind="index" class="vinculo-footer-pantalla-emergente">{{element.display}}</a>
            </div>
            <div class="footer-columna-item ">
              <h2 class="titulo-footer-pantalla-emergente titulo-footer-pantalla-emergente-mixteco">Corpora</h2>
              <a v-for="(element, index) in datasend.corpora" :key="index" :v-bind="index" class="vinculo-footer-pantalla-emergente">{{element.display}}</a>
            </div>
            <div class="footer-columna-item ">
              <h2 class="titulo-footer-pantalla-emergente titulo-footer-pantalla-emergente-mixteco">Grammar</h2>
              <a v-for="(element, index) in datasend.grammar" :key="index" :v-bind="index" class="vinculo-footer-pantalla-emergente">{{element.display}}</a>
            </div>
          </div>
        </div>
      </div>
