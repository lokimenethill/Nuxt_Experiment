...
export default {
  ...
  computed: {
    sendDataWindow() {
      const dataWindow = [
        {
          rootLang: this.$t('languageIndex.totonacan.title'),
          title: this.$t('topicIndex.bottomCards.totonacan.region0'),
          ...
          imgUri: '/generals/IMAGENES_TERMINAL_LANGUAGES_sumario/totonaco_zangozotla-image.jpg',
          lexicons: [
            {
              display: 'lexicon1',
              src: 'uri://',
